...
//         <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-3 text-white drop-shadow-2xl">
//           Welcome to JERSIFY
//         </h1>
        
//         <p className="text-xl sm:text-2xl lg:text-3xl mb-3 text-gray-200 max-w-4xl drop-shadow-xl">
...
//           <NavLink 
//             to="/products" 
//             className="bg-orange-500 hover:bg-orange-600 text-white px-5 py-2 rounded-lg text-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-xl"
//           >
//             Explore Jerseys
//           </NavLink>
...
//           <NavLink 
//             to="/products" 
//             className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-black px-5 py-2 rounded-lg text-lg font-semibold transition-all duration-300 shadow-xl backdrop-blur-sm"
//           >
//             Shop Now
//           </NavLink>
//         </div>
...
//   useEffect(() => {
//     // Cleanup function for video unmount
//     return () => {
//       if (videoRef.current) {
